...
public final class QueryUtils {
    ...
    public static ArrayList<Quake> fetchEarthquakeData(String requestUrl) {
        ...
        return extractQuakes(jsonResponse);
    }
    ...
    private static ArrayList<Quake> extractQuakes(String jsonResponse) {
        ...
        try {
            ...
            Quake quake;
            JSONObject ithObject;
            for (int i = 0; i < featuresArray.length(); i++) {
                ithObject = featuresArray.getJSONObject(i).getJSONObject("properties");
                quake = new Quake(ithObject.getDouble("mag"),
                        ithObject.getString("place"),
                        ithObject.getLong("time"),
                        ithObject.getString("url"));
